...
&\textbf{Atividade}: Avaliação 3 \ \ \ \textbf{Nota}:\underline{\hspace{1cm}}/18pts\\
&\textbf{Estudante}:\underline{\hspace{10cm}}
\end{tabular}
%-------------------------------------------------------
\begin{itemize}
    \item Respostas sem justificativas \textbf{NÃO} serão consideradas.
    \item Essa prova tem o valor de \textbf{18 pontos}. Cada item vale \textbf{6 pontos}.

\end{itemize}

\begin{enumerate}
    \item Resolva os PVIs a seguir usando a Trnsformada de Laplace:
